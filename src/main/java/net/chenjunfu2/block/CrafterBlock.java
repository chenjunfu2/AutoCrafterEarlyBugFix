...
import net.chenjunfu2.registry.ModCriteria;
import net.chenjunfu2.util.ItemScattererAccessor;
import net.chenjunfu2.block.entity.CrafterBlockEntity;
import net.chenjunfu2.recipe.RecipeCache;
import net.chenjunfu2.registry.ModBlockEntities;
import net.chenjunfu2.registry.ModProperties;
import net.chenjunfu2.registry.ModWorldEvents;
