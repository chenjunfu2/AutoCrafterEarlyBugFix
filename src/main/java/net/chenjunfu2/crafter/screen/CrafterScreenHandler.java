...
package net.chenjunfu2.crafter.screen;

import net.minecraft.network.PacketByteBuf;
import net.minecraft.util.math.BlockPos;
import net.chenjunfu2.crafter.registry.ModScreenHandlers;
import net.chenjunfu2.crafter.block.CrafterBlock;
...
import net.chenjunfu2.crafter.screen.slot.CrafterInputSlot;
import net.chenjunfu2.crafter.screen.slot.CrafterOutputSlot;
